...
export function Legalizacion_investigacion() {
   ...
   <div>
      ...
      <div className="contenedor">
        <div className="columna columna1">
          ...
          <a href="ruta/al/archivo.pdf" target="_blank" rel="noopener noreferrer">Instructivo de legalización de investigación.pdf</a>
          <p></p>
...
export default Legalizacion_investigacion;
