...
export function Legalizacion_proyecto() {
   ...
   <div>
      ...
      <div className="contenedor">
        <div className="columna columna1">
          ...
          <a href="ruta/al/archivo.pdf" target="_blank" rel="noopener noreferrer">Instructivo de legalización convenio o proyecto especial.pdf</a>
          <p></p>
...
export default Legalizacion_proyecto;
