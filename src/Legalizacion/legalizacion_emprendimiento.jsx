...
export function Legalizacion_emprendimiento() {
   ...
   <div>
      ...
      <div className="contenedor">
        <div className="columna columna1">
          ...
          <a href="ruta/al/archivo.pdf" target="_blank" rel="noopener noreferrer">Instructivo de legalización Emprendimiento.pdf</a>
          <p></p>
...
export default Legalizacion_emprendimiento;
