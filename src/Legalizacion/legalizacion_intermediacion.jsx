...
export function Legalizacion_intermediacion() {
  ...
  const fileInputRef4 = useRef(null); // Referencia al tercer elemento de entrada de archivo
   ...
   <div>
      ...
      <div className="contenedor">
        <div className="columna columna1">
          ...
          <a href="ruta/al/archivo.pdf" target="_blank" rel="noopener noreferrer">Instructivo de legalización de contrato de aprendizaje.pdf</a>
          <p></p>
        ...
        <h1 className="h1_diff">Subir documentos</h1>
          <div className='cont_boton'>
            ...
            <h2 className="h2_leg">Carta de autorizacion para la elaboracion de proyectos o propuestas de mejora</h2>
            <p className='p_leg'>Selecciona archivo pdf</p>
            ...
            <p className='p_leg'>Selecciona archivo pdf</p>
            <input type="file" ref={fileInputRef4} />
...
export default Legalizacion_intermediacion;
