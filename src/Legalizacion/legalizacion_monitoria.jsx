...
export function Legalizacion_monitoria() {
   ...
   <div>
      ...
      <div className="contenedor">
        <div className="columna columna1">
          ...
          <a href="ruta/al/archivo.pdf" target="_blank" rel="noopener noreferrer">Instructivo de legalización Monitoria Docente.pdf</a>
          <p></p>
        ...
        <h1 className="h1_diff">Subir documentos</h1>
          <div className='cont_boton'>
            ...
            <h2 className="h2_leg">Subir Memorando</h2>
            ...
            <h2 className="h2_leg">Copia documento de identidad</h2>
            <p className='p_leg'>Selecciona archivo pdf</p>
...
export default Legalizacion_monitoria;
